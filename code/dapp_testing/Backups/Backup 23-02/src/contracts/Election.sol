...
contract Election {
    ...
    function editElectionName(string memory _name, uint _electionId) public {
        require(admins[_electionId] == msg.sender, "You do not have permissions to change this election");
    ...
    function deleteCandidate(uint _candidateId) public {
        require(admins[candidates[_candidateId].electionId] == msg.sender, "You do not have permissions to delete candidates.");
